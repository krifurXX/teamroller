...
export const roles: Role[] = [
  ...
  },
  {
    ...
    strengths: [
      'Samarbetsvillig och diplomatisk',
      'Lyssnar aktivt och förstår andras perspektiv',
      'Skapar bra stämning och minskar friktion i gruppen',
    ],
    weaknesses: [
      'Kan vara obeslutsam i kritiska lägen',
      'Undviker konfrontation även när det behövs',
      'Har svårt att ta ställning när gruppen är oenig',
    ],
    tips: [
      'Använd din förmåga att läsa av stämningen för att förebygga konflikter',
      'Öva på att uttrycka din egen åsikt även när den skiljer sig från gruppens',
      'Påminn dig själv att konstruktiv konflikt ibland är nödvändig för bra beslut',
    ],
    color: '#F59E0B',
  },
  {
